  ...
  <div id="main-container">
    <div id="inner-main-container">
      ...
      <div id="nav-content-container">
        <nav>
          <ul id="nav-list">
            <div className="row-break">
              ...
              <li className="nav-item">
                <Link to="/list_of_works/">list of works</Link>
              </li>
            </div>
            <div className="row-break">
              <li className="nav-item">
        ...
        {children()}
        <div id="right-content-margin" />
      </div>
    </div>
    <div id="footer">
      <span id="footer-text">
        All photos by Francis Leduc-Bélanger. Design by Michael Mansourati. All
        rights reserved, © Keith Stratton 2018
      </span>
    </div>
  </div>
)
